Harvester Parts v75 - final mobile/auth package
...
5) Cache version bumped to v75 so old browser/service-worker files refresh.
6) Package has one main root folder only: harvester-parts-github-v75. There are no nested project folders.

How to upload to GitHub without deleting old files:
1) Unzip this package.
2) Open the harvester-parts-github-v75 folder.
