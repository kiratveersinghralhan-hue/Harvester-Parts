const CACHE='hp-supabase-v80-route-fix';
const ASSETS=['./','./index.html','./styles.css?v=80','./app.js?v=80','./language-ux-patch.js?v=80','./supabase-config.js?v=80','./logo-192.png'];
